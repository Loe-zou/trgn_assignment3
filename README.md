...
**Three scripts of the assignment is listed and described below (make sure to have all the unit test file to be downloaded and placed at the same location with the python file to work):**
